...
public class SignIn extends AppCompatActivity
        implements View.OnClickListener { //to add on click functionality
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignIn = findViewById(R.id.edtName);
        mPassSignIn = findViewById(R.id.edtPass);
        ...
        mButtonSignIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(SignIn.this,PostingActivity.class);
                startActivity(i);
            }
        });
